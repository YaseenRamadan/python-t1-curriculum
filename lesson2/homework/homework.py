...
user_animal = input("user what's your favorite animal")
user_color = input("user what's your favorite color ")
print("A",user_color,user_animal,"would be amazing")
# Homework Problem 3
...
user_pushups= input("user how many push-ups can you do")
v= int(user_pushups)
print(v * 7)
# Homework Problem 5
